...
set_instance_assignment -name IO_STANDARD "1.3V True Differential Signaling" -to REFCLK_3B0_p
set_instance_assignment -name INPUT_TERMINATION DIFFERENTIAL -to REFCLK_3B0_p
...
set_instance_assignment -name INPUT_TERMINATION DIFFERENTIAL -to LPDDR4B_REFCK_p
